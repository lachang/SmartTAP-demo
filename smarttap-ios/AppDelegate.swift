...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        Gimbal.setAPIKey("c470063b-00e4-4e02-9b07-803ddd83e7c1", options: nil)
        ...
        print("Registered notification")
            ...
            print("Started receiving communications")
        
        return true
    }
    
    func application(application: UIApplication, didRegisterUserNotificationSetings notificationSettings: UIUserNotificationSettings) {
        if(!GMBLPlaceManager.isMonitoring()) {
            GMBLPlaceManager.startMonitoring()
        }
